...
HEVY_TO_GARMIN: dict[str, tuple[int, int]] = {
    ...
    "Bench Press (Cable)": (
        0,
        20,
    ),  # bench_press / single_arm_cable_chest_press (closest cable bench)
    ...
    "Decline Bench Press (Barbell)": (
        0,
        5,
    ),  # bench_press / decline_dumbbell_bench_press (closest decline)
    ...
    "Decline Bench Press (Smith Machine)": (
        0,
        22,
    ),  # bench_press / smith_machine_bench_press (closest)
    ...
    "Incline Bench Press (Smith Machine)": (
        0,
        8,
    ),  # bench_press / incline_barbell_bench_press (closest)
    "Incline Chest Press (Machine)": (
        0,
        9,
    ),  # bench_press / incline_dumbbell_bench_press (closest machine)
    ...
    "Chest Press (Machine)": (
        0,
        22,
    ),  # bench_press / smith_machine_bench_press (machine, not free-weight)
    ...
    "Plate Squeeze (Svend Press)": (
        0,
        12,
    ),  # bench_press / kettlebell_chest_press (closest svend press)
    # ======================================================================= #
    ...
    "Bent Over Row (Band)": (
        23,
        0,
    ),  # row / barbell_straight_leg_deadlift_to_row (closest band row)
    ...
    "Back Extension (Weighted Hyperextension)": (
        13,
        26,
    ),  # hyperextension / weighted_spine_extension
    ...
    "Seated Shoulder Press (Machine)": (
        24,
        20,
    ),  # shoulder_press / smith_machine_overhead_press (closest machine)
    "Shoulder Press (Dumbbell)": (24, 15),  # shoulder_press / overhead_dumbbell_press
    "Shoulder Press (Machine Plates)": (
        24,
        20,
    ),  # shoulder_press / smith_machine_overhead_press (closest)
    "Single Arm Landmine Press (Barbell)": (
        24,
        18,
    ),  # shoulder_press / single_arm_dumbbell_shoulder_press (closest)
    ...
    "Lateral Raise (Band)": (
        14,
        11,
    ),  # lateral_raise / leaning_dumbbell_lateral_raise (closest band)
    ...
    "Shoulder Extension": (
        25,
        3,
    ),  # shoulder_stability / bent_arm_lateral_raise_and_external_rotation
    "Shoulder Taps": (
        25,
        3,
    ),  # shoulder_stability / bent_arm_lateral_raise_and_external_rotation (closest)
    # ======================================================================= #
    ...
    "Behind the Back Wrist Curl (Barbell)": (
        7,
        18,
    ),  # curl / dumbbell_wrist_curl (closest wrist curl)
    ...
    "Seated Incline Hammer Curl (Dumbbell)": (
        7,
        16,
    ),  # curl / dumbbell_hammer_curl (incline variant)
    ...
    "Single Arm Curl (Cable)": (
        7,
        7,
    ),  # curl / behind_the_back_one_arm_cable_curl (closest single arm)
    ...
    "Seated Triceps Press": (
        30,
        20,
    ),  # triceps_extension / seated_barbell_overhead_triceps_extension
    "Single Arm Tricep Extension (Dumbbell)": (
        30,
        24,
    ),  # triceps_extension / single_arm_dumbbell_overhead_triceps_extension
    "Single Arm Triceps Pushdown (Cable)": (
        30,
        39,
    ),  # triceps_extension / triceps_pressdown (single arm)
    ...
    "Triceps Extension (Machine)": (
        30,
        5,
    ),  # triceps_extension / cable_overhead_triceps_extension (closest)
    ...
    "Reverse Grip Triceps Pushdown": (
        30,
        39,
    ),  # triceps_extension / triceps_pressdown (reverse grip)
    "Triceps Rope Pushdown": (30, 19),  # triceps_extension / rope_pressdown
    "Wide-Elbow Triceps Press (Dumbbell)": (
        30,
        15,
    ),  # triceps_extension / overhead_dumbbell_triceps_extension (closest)
    # ======================================================================= #
    ...
    "Single Leg Standing Calf Raise (Barbell)": (
        1,
        15,
    ),  # calf_raise / single_leg_standing_calf_raise (barbell)
    "Single Leg Standing Calf Raise (Dumbbell)": (
        1,
        16,
    ),  # calf_raise / single_leg_standing_dumbbell_calf_raise
    "Single Leg Standing Calf Raise (Machine)": (
        1,
        15,
    ),  # calf_raise / single_leg_standing_calf_raise (machine)
    ...
    "Hip Abduction (Machine)": (
        11,
        29,
    ),  # hip_stability / weighted_standing_hip_abduction (machine is loaded)
